...
import { ProductController } from '../../../src/controllers/TransferTime';
import { TransferTime } from '../../../src/models/TransferTime';
...
describe('#Service / Controllers / TransferTime', () => {
  ...
  describe('/getProductById', () => {
    it('should return message when id passed as not a number', async () => {
      ...
      sandbox.stub(TransferTime, 'findOne').returns(null);
    ...
    it('should return data from db when item with requested id exists', async () => {
      ...
      sandbox.stub(TransferTime, 'findOne').returns(productFromDB);
      const getSpy = sinon.spy(response, 'json');
  ...
  describe('/getAllProducts', () => {
    it('should return nothing when db is empty', async () => {
      ...
      sandbox.stub(TransferTime, 'find').returns(find);
